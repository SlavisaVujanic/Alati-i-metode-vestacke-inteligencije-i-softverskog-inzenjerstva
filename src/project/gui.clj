                        ...
                        (actionPerformed [evt]
                          (let [file-path (str (System/getProperty "user.home") "/Desktop/TMM.pdf")
                                data [[(format "%-12s %-12s %-2s %-12s %-14s %-3s %-8s %-22s %-3s  %-12s %-12s %-2s %-12s %-12s  %-2s %-12s %-12s" "Data" "Value" "" "0-1*" "Inlet" ""  "1*-2*" "Compressor" "" "2*-3*"  "Combustion chamber" "" "3*-4*" "Turbine" "" "4*-5" "Jet")]
                                      ...
                                      ["---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"]
                                      [(format "%-12s %-12s %-2s %-12s %-14s %-3s %-8s %-22s %-3s  %-12s %-12s %-2s %-12s %-12s  %-2s %-12s %-12s" "ρ0" (.getText tmm-par25-text) "" "" "" ""  "" "" "" ""  "" "" "δ" (.getText tmm-par28-text) "" "f(M)" (.getText tmm-jet-text6))]
                                      ["---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"]
                                      [(format "%-12s %-12s %-2s %-12s %-14s %-3s %-8s %-22s %-3s  %-12s %-12s %-2s %-12s %-12s  %-2s %-12s %-12s" "H" (.getText tmm-par7-text) "" "F" (.getText tmm-other-text1) "N"  "" "" "" ""  "" "" "" "" "" "Aiz" (.getText tmm-jet-text7))]
                                      ["---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"]
                                      [(format "%-12s %-12s %-2s %-12s %-14s %-5s %-8s %-22s %-3s  %-12s %-12s %-2s %-12s %-12s  %-2s %-12s %-12s" "p0" (.getText tmm-par26-text) "" "Csp" (.getText tmm-other-text3) "kg/Ns"  (.getText tmm-other-text4) "kg/daNh" "" ""  "" "" "" "" "" "" "")]
                                      ["---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"]
