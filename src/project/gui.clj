...
(.addActionListener calc-tmm-button
                    (proxy [ActionListener] []
                      (actionPerformed [evt]
                        ...
                        (.setText tmm-par9-text (format "%.3f" (proj/a0 (Double/parseDouble(.getText tmm-par3-text)) (Double/parseDouble (.getText tmm-par18-text)) (Double/parseDouble (.getText tmm-par24-text)))))
