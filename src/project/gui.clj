...
(.addActionListener calc-nmm-button
  ...
  (.setBounds tmm-compressor-label2 130 385 70 30)
  (.setBounds tmm-compressor-text2 210 385 50 30)
  ...
  (.setBounds tmm-chamber-label1 130 440 60 30)
  (.setBounds tmm-chamber-text1 210 440 50 30)
  ...
  (.setBounds tmm-turbine-label2 130 500 70 30)
  (.setBounds tmm-turbine-text2 210 500 50 30)
  (.setEditable tmm-turbine-text2 false)
  (.setBounds tmm-turbine-label3 270 500 60 30)
  (.setBounds tmm-turbine-text3 340 500 50 30)
  ...
  (.setBounds tmm-turbine-label5 530 500 70 30)
  (.setBounds tmm-turbine-text5 610 500 50 30)
  (.setEditable tmm-turbine-text5 false)
  (.setBounds tmm-turbine-label6 270 530 60 30)
  (.setBounds tmm-turbine-text6 340 530 50 30)
  ...
  (.setBounds tmm-jet-label5 530 590 70 30)
  (.setBounds tmm-jet-text5 610 590 50 30)
  ...
  (.setBounds tmm-other-label1 110 690 60 30)
  (.setBounds tmm-other-text1 180 690 50 30)
  (.setEditable tmm-other-text1 false)
  (.setBounds tmm-other-label2 240 690 70 30)
  (.setBounds tmm-other-text2 320 690 50 30)
...
(doseq [component (concat fields-one fields-zero fields-expr labels-expr labels-one labels-zero btns)]
  ...
  (doto tmm-frame
    ...
    (.add tmm-inlet-text5)
    (.add tmm-compressor-label)
    (.add tmm-compressor-label1)
    (.add tmm-compressor-text1)
    (.add tmm-compressor-label2)
    (.add tmm-compressor-text2)
    (.add tmm-compressor-label3)
    (.add tmm-compressor-text3)
    (.add tmm-compressor-label4)
    (.add tmm-compressor-text4)
    (.add tmm-compressor-label5)
    (.add tmm-compressor-text5)
    (.add tmm-chamber-label)
    (.add tmm-chamber-label1)
    (.add tmm-chamber-text1)
    (.add tmm-chamber-label2)
    (.add tmm-chamber-text2)
    (.add tmm-chamber-label3)
    (.add tmm-chamber-text3)
    (.add tmm-turbine-label)
    (.add tmm-turbine-label1)
    (.add tmm-turbine-text1)
    (.add tmm-turbine-label2)
    (.add tmm-turbine-text2)
    (.add tmm-turbine-label3)
    (.add tmm-turbine-text3)
    (.add tmm-turbine-label4)
    (.add tmm-turbine-text4)
    (.add tmm-turbine-label5)
    (.add tmm-turbine-text5)
    (.add tmm-turbine-label6)
    (.add tmm-turbine-text6)
    (.add tmm-jet-label)
    (.add tmm-jet-label1)
    (.add tmm-jet-text1)
    (.add tmm-jet-label2)
    ...
    (.add tmm-jet-text7)
    (.add tmm-other-label)
    (.add tmm-other-label1)
    (.add tmm-other-text1)
    (.add tmm-other-label2)
    (.add tmm-other-text2)
    (.add tmm-other-label3)
    (.add tmm-other-text3)
    (.add tmm-other-text4)
    ))