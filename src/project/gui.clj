...
(.addActionListener calc-nmm-button
  ...
  (.setBounds tmm-par25-label 110 165 40 30)
  (.setBounds tmm-par25-text 160 165 50 30)
  (.setBounds tmm-par26-label 220 165 40 30)
  (.setBounds tmm-par26-text 270 165 50 30)
  (.setBounds tmm-par27-label 330 165 40 30)
